      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-6 rounded-lg" style={{ backgroundColor: '#1a1a1a', border: `2px solid ${BRAND_COLORS.primary}` }}>
            ...
            <p className="text-xs text-gray-400">Este analizador fue creado por Gabriel Sebastian Web para ayudarte a posicionar tu marca de manera automática y profesional.</p>
          </div>
        </div>
      </div>
    </div>
